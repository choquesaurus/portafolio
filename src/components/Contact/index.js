    ...
    if (!(mensaje.length > 0) || !(correo.length > 0)) {
      ...
      try {
        ...
        const {
          ...
          "https://portafolio-functions-backend.vercel.app/api/msj",
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Para suscribirse a este sitio web, ingrese su dirección de correo
            electrónico y luego su mensaje aquí . Le enviaremos actualizaciones
            de vez en cuando.
          </DialogContentText>
          {emailerror === true ? (
            <TextField
